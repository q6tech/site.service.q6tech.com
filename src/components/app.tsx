            ...
            <div className="grow flex justify-center items-center">
                <div className="flex flex-col rounded-lg">
                    <div className="text-8xl text-gray-950 text-center animate-fade animate-ease-in-out">
                        Be <span className="font-bold hero-bold-text animate-wiggle animate-infinite animate-duration-[8000ms] animate-ease-in-out">Bold!</span>
                    </div>
...
function Areas() {
    ...
    const apiImg = new URL("../assets/landing/api.webp", import.meta.url);
    const databasesImg = new URL("../assets/landing/databases.webp", import.meta.url);
    const securityImg = new URL("../assets/landing/security.webp", import.meta.url);
    const storageImg = new URL("../assets/landing/storage.webp", import.meta.url);
    const websitesImg = new URL("../assets/landing/websites.webp", import.meta.url);
    const networkingImg = new URL("../assets/landing/networking.webp", import.meta.url);
